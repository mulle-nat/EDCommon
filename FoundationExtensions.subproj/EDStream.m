...
- (void)setEnforcesCanonicalLinebreaks:(BOOL)flag
{
    if((flag == YES) && (flags.linebreakStyle != EDCanonicalLinebreakStyle))
        [NSException raise:NSInvalidArgumentException format:@"-[%@ %@]: Can only enforce canonical linebreaks if linebreak style is EDCanonicalLinebreakStyle.", NSStringFromClass(EDObjcIsa), NSStringFromSelector(_cmd)];
...
- (void)setEscapesLeadingDots:(BOOL)flag
{
    ...
    if((flag == YES) && (flags.linebreakStyle != EDCanonicalLinebreakStyle))
        [NSException raise:NSInvalidArgumentException format:@"-[%@ %@]: Can only escape leading dots if linebreak style is EDCanonicalLinebreakStyle.", NSStringFromClass(EDObjcIsa), NSStringFromSelector(_cmd)];
